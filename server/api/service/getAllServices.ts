/**
 * This API allows to get all the projects that SheRise is involved in, only with the details that are needed
 * to build the related clickable cards and slides.
 */
...
// fires when "/activities" or "/activities/services" is loaded
